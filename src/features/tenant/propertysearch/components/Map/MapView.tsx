...
//           (geolocateControl.parentElement as HTMLElement).style.display =
//             "none";
//         }
//       };

//       // Wait a bit for the control to be added to the DOM
//       setTimeout(hideDefaultControl, 100);
//     }
//   }, [mapLoaded]);
...
//       {mapLoaded && (
//         <div
//           className="absolute bottom-25 right-4 z-10"
//           onClick={handleLocationButtonClick}
//         >
//           <button
//             className={`w-10 h-10 rounded-full flex items-center justify-center shadow-md ${
//               locationAvailable ? "bg-white" : "bg-white"
//             }`}
//           >
//             {locationAvailable ? (
//               <svg
